...
function Contact() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-4 text-center dark:text-slate-50">Contact Us</h1>
      <div className="flex flex-col md:flex-row mt-10">
        <div className="w-1/3 m-auto flex flex-col gap-5">
          <h2 className="text-2xl font-semibold mb-2 dark:text-slate-50">Contact Information</h2>
          <p className="dark:text-slate-50">Email: example@example.com</p>
          <p className="dark:text-slate-50">Phone: +1234567890</p>
          <p className="dark:text-slate-50">Address: 123 Street, City, Country</p>
          <div className="text-gray-300 flex items-center gap-5">
            <a href="/">
              <FaTwitter className="w-8 h-8 dark:text-slate-50" />
            </a>
            <a href="/">
              <FaLinkedin className="w-8 h-8 dark:text-slate-50" />
            </a>
            <a href="/">
              <FaFacebook className="w-8 h-8 dark:text-slate-50" />
            </a>
            <a href="/">
              <MdEmail className="w-10 h-10 dark:text-slate-50" />
            </a>
          </div>
        </div>
